...
var _trialProductPreview = require("trial_product_preview");
...
const imageContainerHTML1 = (0, _trialProductPreview.generateImageContainer)(explanationsJS, {
    imagePath: imgPath,
    imageId: "js",
    explanations: []
});
...
if (imgcontainerElement) {
    ...
    if (id1) (0, _trialProductPreview.displayData)("click", "js");
}
const explanations = [
    {
        label: "JavaScriptLogo",
...
const imageContainerHTML2 = (0, _trialProductPreview.generateImageContainer)(explanationsJS, {
    imagePath: imgPath1,
    imageId: "js1",
    explanations: []
});
...
if (imgcontainerElement) {
    ...
    if (id1) (0, _trialProductPreview.displayData)("mouseover", "js1");
}

},{"trial_product_preview":"cWNrS"}],"cWNrS":[function(require,module,exports) {
/**
 * @author Jinal Tandel
 ...
 * @returns Container
 */ parcelHelpers.export(exports, "generateImageContainer", ()=>generateImageContainer);
function displayData(event, id) {
    document.addEventListener("DOMContentLoaded", ()=>{
        const target = document.getElementById(id);
        const explanations = document.querySelectorAll(`.${id}explanation`);
        target === null || target === void 0 || target.addEventListener(event, ()=>{
            explanations.forEach((explanation)=>{
                explanation.style.display = "block";
            });
        });
        target === null || target === void 0 || target.addEventListener("mouseleave", ()=>{
            explanations.forEach((explanation)=>{
...
function generateImageContainer(explanations, imageContainer) {
    ...
    explanations.forEach((explanation, index)=>{
        ...
        if (explanation.labelPosition) {
            const transformedString = Object.entries(explanation.labelPosition).map(([key, value])=>`${key}: ${value}`).join(";");
        ...
        const transformedString = Object.entries(transformedObject).map(([key, value])=>`${key}: ${value}`).join(";");
...
},{}]},["2UeK4","bB7Pu"], "bB7Pu", "parcelRequiree8ef")
